...
# --- 2. Database and Verification Functions ---

def build_face_database(directory, embedder_instance):
    """
    Builds a database of face embeddings from a directory of images.
    The filename (without extension) is used as the person's name.
    
    Args:
        directory (str): The path to the folder containing database images.
        embedder_instance (FaceNet): An instance of the FaceNet embedder.
        
    Returns:
        dict: A dictionary mapping names to face embeddings.
    """
    database = {}
